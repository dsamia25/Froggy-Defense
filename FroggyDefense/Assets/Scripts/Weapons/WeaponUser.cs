    ...
    public class WeaponUser : MonoBehaviour
    {
        ...
        private void OnTriggerEnter2D(Collider2D collision)
        {
            ...
            if (_weapon.HasMeleeAttack)
            {
                ...
                target.TakeDamage(new DamageInstance(_player, _weapon.MeleeDamage + (_weapon.HasMeleeDamageScaling ? _weapon.GetStatScaling(_weapon.MeleeDamageScalingFactor) : 0), _weapon.MeleeDamageType, false));
            }
